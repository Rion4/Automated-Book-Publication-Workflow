...
class ReviewerAgent:
    ...
    def __init__(self):
        ...
        logging.info("Reviewer Agent ready.")
    ...
    def run(self, spun_text: str) -> tuple[str, str]:
        ...
        logging.info("Sending request to Gemini for review and refinement...")
        try:
            ...
            if "**Revised Chapter:**" in full_response_text:
                ...
                logging.info("Successfully received and parsed the review.")
                return feedback, revised_text
            else:
                logging.warning("Reviewer output was not in the expected format.")
